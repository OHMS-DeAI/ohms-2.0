...
import { idlFactory } from './ohms_agent.did.js';
export { idlFactory } from './ohms_agent.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OHMS_AGENT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ohms_agent.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ohms_agent canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ohms_agent.did.js")._SERVICE>}
 */
export const ohms_agent = createActor(canisterId);
