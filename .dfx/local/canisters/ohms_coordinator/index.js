...
import { idlFactory } from './ohms_coordinator.did.js';
export { idlFactory } from './ohms_coordinator.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OHMS_COORDINATOR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ohms_coordinator.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ohms_coordinator canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ohms_coordinator.did.js")._SERVICE>}
 */
export const ohms_coordinator = createActor(canisterId);
