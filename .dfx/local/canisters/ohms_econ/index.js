...
export const canisterId = process.env.CANISTER_ID_OHMS_ECON;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ohms_econ.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ohms_econ canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ohms_econ.did.js")._SERVICE>}
 */
export const ohms_econ = createActor(canisterId);
