...
export const canisterId = process.env.CANISTER_ID_OHMS_UI;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ohms_ui.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ohms_ui canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ohms_ui.did.js")._SERVICE>}
 */
export const ohms_ui = createActor(canisterId);
