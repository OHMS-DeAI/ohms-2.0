...
import { idlFactory } from './ohms_website.did.js';
export { idlFactory } from './ohms_website.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_OHMS_WEBSITE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ohms_website.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ohms_website canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ohms_website.did.js")._SERVICE>}
 */
export const ohms_website = createActor(canisterId);
